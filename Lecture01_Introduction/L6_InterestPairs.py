...
def data_scientists_who_like(target_interest):
    return [u_id  for u_id, u_interest in interests  if u_interest == target_interest]

interest_statistics = data_scientists_who_like("statistics")
print(interest_statistics)